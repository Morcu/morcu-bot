...
import es.tid.cog.chat.chatadapter.ChatAdapter;
import es.tid.cog.chat.chatadapter.ChatMessage;
...
import es.tid.cog.eventbus.dispatchers.SpeechDispatcher;
