...
import es.tfg.cog.eventbus.dispatchers.WebViewDispatcher;
...
public class ChatAdapter extends BaseAdapter {
    ...
    private void initRecyclerView(final RecyclerView recyclerView,
        ...
        layoutManager.setPostLayoutListener(new CarouselZoomPostLayoutListenerTT());
    ...
    private static final class CarrousellAdapter
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            ...
            final ArrayList<es.tfg.cog.model.Model.ChannelData.Button> buttons =
                element.getButtons();

            int buttonsSize = buttons.size();
            Log.i(TAG, "__TT__onClick: BUTTONS " + buttonsSize);
            //int buttonsSize = 0;
            if (buttonsSize == 3) {
                Button buttonWidget = null;
                es.tfg.cog.model.Model.ChannelData.Button button = null;
                ...
                if (isWebUrl) {
                    ...
                    buttonWidget.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(final View view) {
                            Log.i(TAG, "__TT__onClick: YA VISTO " + title);
                ...
                if (isPostBack) {
                    buttonWidget.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(final View view) {
                            Log.i(TAG, "__TT__onClick: MAS SIMILARES " + title);
                ...
                if (isWebUrl) {
                    ...
                    buttonWidget.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(final View view) {
                            Log.i(TAG, "__TT__onClick: VER AHORA " + title);
                            WebViewDispatcher.processUrl(url);
                        }
                    });
                }
                ...
                es.tfg.cog.model.Model.ChannelData.Button button = buttons.get(MORE_OR_ESA);
                ...
                Log.i(TAG, "__TT__onClick: MORE_OR_ESA__msg__ " + msg);

                if (isPostBack) {
                    buttonWidget.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(final View view) {
                            Log.i(TAG, "__TT__onClick: MORE_OR_ESA " + title);
                            BotMessageDispatcher.processMessageToBot(msg);
                        }
                    });
                }
    ...
    public class CarouselZoomPostLayoutListenerTT
