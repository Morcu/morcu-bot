...
import es.tfg.cog.chat.ChatView;
import es.tfg.cog.dl.DLManager;
import es.tfg.cog.emulator.Emulator;
import es.tfg.cog.eventbus.events.OpenWebViewEvent;
import es.tfg.cog.model.Model.Credentials;
import es.tfg.cog.model.Model.From;
import es.tfg.cog.model.Model.Payload;
import es.tfg.cog.speech.SpeechManager;
