...
function TFGBasicosVisitorApp(intent, bName) {
...
exports.TFGBasicosVisitorApp = TFGBasicosVisitorApp;

TFGBasicosVisitorApp.prototype.constructor = TFGBasicosVisitorApp;

TFGBasicosVisitorApp.prototype.visitDefault = function (ctx) {
...
TFGBasicosVisitorApp.prototype.visitIntents = function (ctx) {
...
TFGBasicosVisitorApp.prototype.visitIntent = function (ctx) {
...
TFGBasicosVisitorApp.prototype.visitFeedback = function (eCtx) {
...
TFGBasicosVisitorApp.prototype.visitPositivo = function (ctx) {
...
TFGBasicosVisitorApp.prototype.visitNegativo = function (ctx) {
...
TFGBasicosVisitorApp.prototype.visitBye = function (eCtx) {
    let ctx = _.isArray(eCtx) ? eCtx : [eCtx];
...
TFGBasicosVisitorApp.prototype.visitGreeting = function (eCtx) {
    let ctx = _.isArray(eCtx) ? eCtx : [eCtx];
