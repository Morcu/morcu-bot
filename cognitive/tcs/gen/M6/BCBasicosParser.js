...
var literalNames = [ null, null, "'genial'", "'perfecto'", "'bien'", "'mal'", 
                     null, "'me'", null, "'seleccion'", "'ahora'", "'si'", 
                     "'ole'", "'acabo'", "'de'", "'verla'", "'la'", "'guardo'", 
                     "'para'", "'mas'", "'tarde'", null, null, null, "'era'", 
                     null, "'adios'", "'vere'", "'pero'", "'no'", "'convences'", 
                     "'nada'", "'muy'", "'negativo'", "'bye'", "'hasta'", 
                     "'luego'", "'voy'", "'ma\u00F1ana'", "'a'", "'trabajar'", 
                     "'un'", "'rato'", "'pronto'", "'chao'", "'es'", "'todo'", 
                     "'serie'", null, "'por'", "'hoy'", "'noches'", "'saludos'", 
                     null, "'tardes'", null, "'ya'", "'has'", "'otra'", 
                     "'vuelto'", "'que'", "'hayas'", "'estoy'", "'nuevo'", 
                     "'vez'", "'empezar'", null, "'prueba'", "'una'", null, 
                     "'aqui'" ];
...
ByeContext.prototype.BYE = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
        return this.getTokens(BCBasicosParser.BYE);
    } else {
        return this.getToken(BCBasicosParser.BYE, i);
    }
};
...
ByeContext.prototype.ADIOS = function() {
    return this.getToken(BCBasicosParser.ADIOS, 0);
};
...
BCBasicosParser.prototype.bye = function() {
    ...
    try {
        ...
        case 1:
            this.enterOuterAlt(localctx, 1);
            this.state = 129;
            this.match(BCBasicosParser.BYE);
            this.state = 133;
            this._errHandler.sync(this);
