...
tipoGenero
  ...
  | ENTRETENIMIENTO | PENSAR | CLASICA | SUSPENSE | MONSTRUO | INTRIGA | THRILLER | WESTER | SITCOM | CRIMEN | POLICIACO
...
tipoEmocion
  : ALEGRIA | TRISTEZA | ODIO | IRA | ENVIDIA | ENFADADO | ENTUSIASMO
   | FUERTE  | NEUTRO | PELIGROSO | SENSIBLE | EGOISTA | VENGANZA | BIEN | MAL
...
VENGANZA
  ...
  ;
BIEN
  : 'bien' | 'super' | 'superior' | 'genial' | 'estupendo'| 'rosa'
  ;
MAL
